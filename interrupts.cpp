...
int main(int argc, char** argv) {
    ...
    while(std::getline(input_file, trace)) {
        ...
        else if (activity == "SYSCALL")
        {
            ...
            execution += std::to_string(current_time) + ", " + std::to_string(delays.at(duration_intr)) + ", SYSCALL: run the ISR\n"; 
            ...
            execution += std::to_string(current_time) + ", " + std::to_string(device_number_delay_time) + ", END_IO: run the ISR\n"; 
